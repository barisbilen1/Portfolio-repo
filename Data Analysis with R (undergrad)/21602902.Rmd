---
  title: <center> <h3> Fall 2020 </h3> <h2> IE 451 Applied Data Analysis </h2> <h3> taught by Savaş Dayanık </h3>  <h2> Midterm Examination </h2>  <h3> done by </h3> <h3> <span style="color:red">*Ali Barış Bilen* </span> </h3>  <h4> <span style="color:red">*21602902* </span> </h4></center>
  pagetitle: IE 451 Midterm Fall 2020 
  date: <center> between 8:30 and 12:30 on Wednesday, 11 November 2020</center>
  output: 
...
Write your responses below each part in the [Rmd file](midterm.Rmd). 

- You may use your notes, your textbook, or internet.
- You may NOT offer help to or seek help from anybody inside or outside classroom in any form.
- After you finish the exam, 
  - make sure that **Rmd file** can be knitted, and you have created the **final version of html file,**
  - compress  **Rmd** and **html** files  into a single zip file, 
  - name the zip file with your Bilkent student ID 
    - e.g., 21600023.zip, and 
    - please, do NOT append your name/lastname or any tags like "midterm", etc to file name,
  - **upload** the zip file to the [IE 451 moodle page](https://moodle.bilkent.edu.tr/2020-2021-fall/).
...
*balance* of female customers seem to be more than those of male customers. Although their medians are the same, most of the observations of *balance* is greaterin female customers, as we can infer from the box-plots above.
