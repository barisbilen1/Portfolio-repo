...
# It was really hard to compare a linear model and a logistic 
# model because their dynamics, for example,
# how they define the response variable, are different. 
# It is better to use logistic regression when the
# response is binary outcome. Other than that, I think this
# decision is up to the analyst. Here, it seemed to me that
# linear regression is more suitable for this case.
