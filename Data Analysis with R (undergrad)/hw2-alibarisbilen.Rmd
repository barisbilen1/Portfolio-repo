...
* Read
  ...
  * Sections 1 and 3.1-3.3 of Chapter 5 
from ISLR.

* Solve Exercise 8 (a)-(e) at the end of Chapter 5. Write your responses below each part in the [Rmd file](hw2.Rmd). 

  - Compress  **Rmd**, **html**, and any data files you may create into a single zip file. 
  - Name the zip file with your Bilkent student ID (e.g., 21400023.zip). 
  - Upload the zip file to the [IE 451 moodle page](https://moodle.bilkent.edu.tr/2020-2021-fall/).
  - Be sure that **Rmd file** can be knitted, and the **final version of html file** are submitted.
...
8. In this exercise, you will perform cross-validation on a simulated data set.
